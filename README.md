...
5. Create your loading images as 1920x1080 png files and save them somewhere safe
6. Make a temporary P:\LoadingScreensMod\pics folder
7. Copy the **_first 6_** of your png files into there
8. Open a command prompt and go to P:\LoadingScreensMod and run:
```cmd
...
14. Thats it! You can delete the temporary \pics folder, then compile and test =) :shipit:
